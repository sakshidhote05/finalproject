...
PreparedStatement prst=conn.prepareStatement("insert into landdetails(ltitle,descr,area,addr,surveynum,plotnum,lat,lang,forw,uid)values(?,?,?,?,?,?,?,?,?,?)");
...
prst.setString(9,"Sell");
prst.setString(10,uid);
int i=prst.executeUpdate();
hs.setAttribute("title",ltitle);
%>
<script>
